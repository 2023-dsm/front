...
function UserSign() {
  return (
    <div className='Sign'>
      ...
      <p className="font-grap"><b>전화번호</b></p>
      <input type="text" placeholder="전화번호를 입력해주세요"></input>
      <p className="font-grap"><b>성별</b></p>
      <div className="gander-radio">
        <input className="radio-width" type="radio" name="성별" checked/><p className="ps">여자</p>
        <input className="radio-width" type="radio" name="성별"  /><p className="ps">남자</p>
      </div>
      <p className="adress"><b>주소</b></p>
